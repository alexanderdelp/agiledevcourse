...
## Eclipse & Java
* [Java SE Development Kit 10.0.1](http://www.oracle.com/technetwork/java/javase/downloads/jdk10-downloads-4416644.html)
* [Eclipse IDE for Java Developers (Oxygen 3a)](https://www.eclipse.org/downloads/packages/eclipse-ide-java-developers/oxygen3a)
* [Apache Maven Eclipse Codestyle](http://maven.apache.org/developers/maven-eclipse-codestyle.xml)
## Gradle
* [Gradle](https://gradle.org/)
* [Jacoco Plugin](https://docs.gradle.org/current/userguide/jacoco_plugin.html)
* [PMD Plugin](https://docs.gradle.org/current/userguide/pmd_plugin.html)
## Cloud Service Provider
* [Amazon Web Service](https://aws.amazon.com/de/console/)
